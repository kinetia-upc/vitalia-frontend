...
export const useAnalyticsStore = defineStore('analytics', () => {
    ...
    async function loadAnalyticsData({ force = false } = {}) {
        ...
        try {
            ...
            if (!tenantStore.branchesLoaded || force) tasks.push(tenantStore.fetchBranches())
            if (!tenantStore.appointmentFeesLoaded || force) tasks.push(tenantStore.fetchAppointmentFees())
            ...
            if (!clinicalStore.doctorSpecialitiesLoaded || force) tasks.push(clinicalStore.fetchDoctorSpecialities())
